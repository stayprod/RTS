                        ...
                        <>
                            <div className="row">
                                <div className="col-sm-12 col-md-12 mb-3">
                                    ...
                                    <input type="text" id="newLayoutName" maxLength={500} className="form-control" onChange={onChangeHandlerLayoutName} />
                                </div>
                                <div className="col-sm-12 col-md-12 mb-3">
                        ...
                        : (modalType == "edit") ?
                            ...
                            <>
                                <div className="row">
                                    <div className="col-sm-12 col-md-12 mb-3">
                                        <label className="me-3">Layout Name</label>
                                        <input type="text" id="newLayoutName" maxLength={500} className="form-control" defaultValue={layoutName} onChange={onChangeHandlerLayoutName} />
                                    </div>
                                    <div className="col-sm-12 col-md-12 mb-3">
                                        <label className="me-3">Layout</label>
                                        <div className="d-flex">
