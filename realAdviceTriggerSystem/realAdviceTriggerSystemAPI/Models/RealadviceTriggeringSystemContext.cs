...
//        => optionsBuilder.UseMySQL("server=localhost; port=3306; database=realadvice-triggering-system; user=root; password=1234;Persist Security Info=False;Connect Timeout=300;ConvertZeroDateTime=True");
